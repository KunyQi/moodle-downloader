...
- `assets/demo-*.svg` are real UI renders for the README, generated by `python scripts/gen_demo_svg.py` — regenerate them after changing user-facing UI text or layout.
